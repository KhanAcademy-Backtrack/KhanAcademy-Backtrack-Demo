...
export const metadata:Metadata={title:{default:'BACKTRACK',template:'BACKTRACK'},description:'Your GPS recalculates. So can your learning. Find the missing step, practice with Khan Academy, and return to today’s lesson.',applicationName:'BACKTRACK',openGraph:{title:'BACKTRACK · Your GPS for learning',description:'A learning route that changes with your answers. Find the missing step and practice with Khan Academy.',type:'website'},icons:{icon:[{url:'/favicon.svg?v=route',type:'image/svg+xml'},{url:'/backtrack-icon-32.png',sizes:'32x32',type:'image/png'}],apple:'/backtrack-icon-180.png'}};
