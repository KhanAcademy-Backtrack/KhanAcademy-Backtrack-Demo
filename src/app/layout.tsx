...
export const metadata:Metadata={title:{default:'Dunlo',template:'%s · Dunlo'},description:'Explore playable ideas and focused Khan Academy lessons, try fresh questions, and keep learning. Dunlo is a free independent project.',applicationName:'Dunlo',openGraph:{title:'Dunlo · Explore. Learn. Return.',description:'A little curiosity. A useful next step with Khan Academy.',type:'website'},icons:{icon:[{url:'/favicon.svg?v=dunlo',type:'image/svg+xml'},{url:'/dunlo-icon-32.png',sizes:'32x32',type:'image/png'}],apple:'/dunlo-icon-180.png'}};
